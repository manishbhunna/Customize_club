...
const MenCollections = ({showAll}) => {
  return (
    <>
      <div className="container py-5">
        <h1 className="text-center fw-bold mb-2">Mens's Collections</h1>
        
        <div className="row justify-content-center">
          {(showAll ? ProductStorage.MenCollections : ProductStorage.MenCollections.slice(0, 4)).map((item, key) => (
