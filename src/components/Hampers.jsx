...
const Hampers = ({showAll}) => {
  return (
    <>
      <div className="container py-5">
        <h1 className="text-center fw-bold mb-2">Personalised Hampers</h1>
        
        <div className="row justify-content-center">
          {(showAll ? ProductStorage.Hamper : ProductStorage.Hamper.slice(0, 4)).map((item, key) => (
